...
# Generated: Fri Jul 17 23:55:51 2020
##################################################
...
class dvbt_rx_demo_8k(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, args='addr=192.168.10.2', spec='', stream_args='', wire_format=''):
        ...
        self.dtv_dvbt_ofdm_sym_acquisition_0 = dtv.dvbt_ofdm_sym_acquisition(1, 8192, 6817, 256, 1)
        self.dtv_dvbt_energy_descramble_0 = dtv.dvbt_energy_descramble(8)
        self.dtv_dvbt_demod_reference_signals_0 = dtv.dvbt_demod_reference_signals(gr.sizeof_gr_complex, 8192, 6048, dtv.MOD_16QAM, dtv.NH, dtv.C2_3, dtv.C1_2, dtv.GI_1_4, dtv.T8k, 1, 4)
        ...
        self.blocks_file_source_0_0_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'Z:\\Projects\\DVBT_Decoder\\adv16.cfile', False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Program Files\\GNURadio-3.7\\bin\\out.ts', False)
